    ...
    <div class="wrapper">
      ...
      <div class="NewsArea1__inner">
        ...
        <div class="NewsArea1__innerItem tabContents active" id="tab1">
          ...
          <ul>
            <div class="NewsArea1__innerItemContentWrap1">
              <li>2023年03月09日</li>
              <li>システム</li>
            </div>


            <div class="NewsArea1__innerItemContentWrap2">
